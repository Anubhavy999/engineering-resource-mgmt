...
export default function UserInfoCard({ user, onSave }) {
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div className="lg:col-span-2 flex flex-row items-center gap-2">
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400 min-w-[60px]">Bio</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90 whitespace-pre-line">{user.bio || "-"}</p>
            </div>
          </div>
        </div>
        <button
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <Input name="email" type="text" value={form.email} disabled />
                </div>
                <div className="col-span-2 lg:col-span-1">
                  <Label>Phone</Label>
                ...
                <div className="col-span-2">
                  <Label>Bio</Label>
                  <Input name="bio" type="text" value={form.bio} onChange={handleChange} />
                </div>
              </div>
            </div>
